...
<h3 align ="center"> CloudKeyWebService MakePayment</h3>
...
<tr><td>CreditCardNumber</td><td><input type="text" name="credit_card_no"/></td></tr>
<tr><td colspan="2" align="center"><input type="submit" value="Make Payment"></td></tr>
</table>
