...
public class MicrosOXILogger extends Logger {

	protected MicrosOXILogger(String name)
	{
		super(name);
	 ...
	 */
	public static void logError(@SuppressWarnings("rawtypes") Class className, String methodName,
			Object objObject) 
	{
	 ...
	 */
	public static void logInfo(@SuppressWarnings("rawtypes") Class className, String methodName,
			String message)
	{
		/* Creates an Instance of Logger */
		Logger objLogger = Logger.getLogger(className.getName());
		...
		{
			objLogger.info(className.getName() + " :: " + methodName + " :: " +
					message);
		}
	}
	 ...
	 * @param message - message to be logged.
	 */
	public static void logDebug(@SuppressWarnings("rawtypes") Class className, String methodName,
			String message) 
	{
		/* Creates an Instance of Logger */
		Logger objLogger = Logger.getLogger(className.getName());
		...
		{
			objLogger.debug(className.getName() + " :: " + methodName + " :: " +
					message);
		}
	}
