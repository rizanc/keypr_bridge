...
/**
 * InstantPaymentNotificationResponse.java
 *
 ...
 */
            ...
            /**
            *  InstantPaymentNotificationResponse bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "InstantPaymentNotificationResponse",
                "ns6");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InstantPaymentNotificationResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "InstantPaymentNotificationResponse",
    ...
    public static class Factory{
        ...
        */
        public static InstantPaymentNotificationResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InstantPaymentNotificationResponse object =
                new InstantPaymentNotificationResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InstantPaymentNotificationResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InstantPaymentNotificationResponse)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
