 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for PackageDate
                        */

                        
                                    protected com.cloudkey.pms.micros.og.hotelcommon.TimeSpan localPackageDate ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPackageDateTracker = false ;

                           public boolean isPackageDateSpecified(){
                               return localPackageDateTracker;
                           }
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.hotelcommon.TimeSpan getPackageDate(){
                               return localPackageDate;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param PackageDate
                               */
                               public void setPackageDate(com.cloudkey.pms.micros.og.hotelcommon.TimeSpan param){
                            localPackageDateTracker = param != null;
                                   
                                            this.localPackageDate=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localPackageIDTracker){
                                           ...
                                           localPackageID.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","PackageID"),
                                               xmlWriter);
                                        } if (localPackageDateTracker){
                                            if (localPackageDate==null){
                                                 throw new org.apache.axis2.databinding.ADBException("PackageDate cannot be null!!");
                                            }
                                           localPackageDate.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","PackageDate"),
                                               xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localPackageIDTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/",
                                    ...
                                    elementList.add(localPackageDate);
                                }
    ...
    public static class Factory{
        ...
        */
        public static PackageIdData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PackageIdData object =
                new PackageIdData();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PackageIdData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PackageIdData)com.cloudkey.pms.micros.og.meetingroom.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","PackageDate").equals(reader.getName())){
                                
                                                object.setPackageDate(com.cloudkey.pms.micros.og.hotelcommon.TimeSpan.Factory.parse(reader));
