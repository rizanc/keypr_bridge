 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.hotelcommon.RegionalSearchCodeType localRegionalSearchCodeType ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.hotelcommon.RegionalSearchCodeType
                           */
                           public  com.cloudkey.pms.micros.og.hotelcommon.RegionalSearchCodeType getRegionalSearchCodeType(){
                               return localRegionalSearchCodeType;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RegionalSearchCodeType
                               */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RegionalSearchCode",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RegionalSearchCode",
                           xmlWriter);
                                    ...
                                    if (localRegionalSearchCodeType != null){
                                        writeAttribute("",
                                           ...
                                           localRegionalSearchCodeType.toString(), xmlWriter);
                                    }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","regionalSearchCodeType"));
    ...
    public static class Factory{
                ...
                public static RegionalSearchCode fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    RegionalSearchCode returnValue = new  RegionalSearchCode();
                ...
                public static RegionalSearchCode fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return RegionalSearchCode.Factory.fromString(content,namespaceUri);
                    } else {
                       return RegionalSearchCode.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static RegionalSearchCode parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RegionalSearchCode object =
                new RegionalSearchCode();
            ...
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    // handle attribute "regionalSearchCodeType"
                    java.lang.String tempAttribRegionalSearchCodeType =
                        
                                reader.getAttributeValue(null,"regionalSearchCodeType");
                            
                   if (tempAttribRegionalSearchCodeType!=null){
                         java.lang.String content = tempAttribRegionalSearchCodeType;
                        
                                                  object.setRegionalSearchCodeType(
                                                        com.cloudkey.pms.micros.og.hotelcommon.RegionalSearchCodeType.Factory.fromString(reader,tempAttribRegionalSearchCodeType));
                                            
                    } else {
                       
                               throw new org.apache.axis2.databinding.ADBException("Required attribute regionalSearchCodeType is missing");
