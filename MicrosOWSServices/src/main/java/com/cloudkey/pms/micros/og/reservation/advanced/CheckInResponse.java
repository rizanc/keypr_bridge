 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns6");
                        ...
                        /**
                        * field for CheckInComplete
                        */

                        
                                    protected com.cloudkey.pms.micros.og.reservation.advanced.CheckInComplete localCheckInComplete ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCheckInCompleteTracker = false ;

                           public boolean isCheckInCompleteSpecified(){
                               return localCheckInCompleteTracker;
                           }
                           ...
                           * @return com.cloudkey.pms.micros.og.reservation.advanced.CheckInComplete
                           */
                           public  com.cloudkey.pms.micros.og.reservation.advanced.CheckInComplete getCheckInComplete(){
                               return localCheckInComplete;
                           }
                            ...
                            /**
                               ...
                               * @param param CheckInComplete
                               */
                               public void setCheckInComplete(com.cloudkey.pms.micros.og.reservation.advanced.CheckInComplete param){
                            localCheckInCompleteTracker = param != null;
                                   
                                            this.localCheckInComplete=param;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localCheckInCompleteTracker){
                                            if (localCheckInComplete==null){
                                                 throw new org.apache.axis2.databinding.ADBException("CheckInComplete cannot be null!!");
                                            }
                                           localCheckInComplete.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","CheckInComplete"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localCheckInCompleteTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/",
                                    ...
                                    elementList.add(localCheckInComplete);
                                } if (localProfileTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/",
                                                                      "Profile"));
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CheckInResponse".equals(type)){
                                ...
                                return (CheckInResponse)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","CheckInComplete").equals(reader.getName())){
                                
                                                object.setCheckInComplete(com.cloudkey.pms.micros.og.reservation.advanced.CheckInComplete.Factory.parse(reader));
