 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DCCCheckRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DCCCheckRequest",
    ...
    public static class Factory{
        ...
        */
        public static DCCCheckRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DCCCheckRequest object =
                new DCCCheckRequest();
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribAmount!=null){
                         java.lang.String content = tempAttribAmount;
                                                 ...
                                                 object.setAmount(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDecimal(tempAttribAmount));
