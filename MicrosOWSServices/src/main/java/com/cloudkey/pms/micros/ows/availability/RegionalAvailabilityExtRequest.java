...
/**
 * RegionalAvailabilityExtRequest.java
 *
 ...
 */
            ...
            /**
            *  RegionalAvailabilityExtRequest bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = RegionalAvailabilityExtRequest
                ...
                */
                        ...
                        /**
                        * field for RegionalAvailabilityExtRequestChoice_type0
                        */

                        
                                    protected com.cloudkey.pms.micros.ows.availability.RegionalAvailabilityExtRequestChoice_type0 localRegionalAvailabilityExtRequestChoice_type0 ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.ows.availability.RegionalAvailabilityExtRequestChoice_type0
                           */
                           public  com.cloudkey.pms.micros.ows.availability.RegionalAvailabilityExtRequestChoice_type0 getRegionalAvailabilityExtRequestChoice_type0(){
                               return localRegionalAvailabilityExtRequestChoice_type0;
                           }
                            ...
                            /**
                               ...
                               * @param param RegionalAvailabilityExtRequestChoice_type0
                               */
                               public void setRegionalAvailabilityExtRequestChoice_type0(com.cloudkey.pms.micros.ows.availability.RegionalAvailabilityExtRequestChoice_type0 param){
                            
                                            this.localRegionalAvailabilityExtRequestChoice_type0=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RegionalAvailabilityExtRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RegionalAvailabilityExtRequest",
                           xmlWriter);
                   }
                                            ...
                                            if (localRegionalAvailabilityExtRequestChoice_type0==null){
                                                 throw new org.apache.axis2.databinding.ADBException("RegionalAvailabilityExtRequestChoice_type0 cannot be null!!");
                                            }
                                           localRegionalAvailabilityExtRequestChoice_type0.serialize(null,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Availability.wsdl",
                                                                      "RegionalAvailabilityExtRequestChoice_type0"));
                            
                            
                                    if (localRegionalAvailabilityExtRequestChoice_type0==null){
                                         throw new org.apache.axis2.databinding.ADBException("RegionalAvailabilityExtRequestChoice_type0 cannot be null!!");
                                    }
                                    elementList.add(localRegionalAvailabilityExtRequestChoice_type0);
                                 if (localStayDateRangeTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Availability.wsdl",
                                                                      "StayDateRange"));
    ...
    public static class Factory{
        ...
        */
        public static RegionalAvailabilityExtRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RegionalAvailabilityExtRequest object =
                new RegionalAvailabilityExtRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RegionalAvailabilityExtRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RegionalAvailabilityExtRequest)com.cloudkey.pms.micros.ows.availability.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() ){
                                                ...
                                                object.setRegionalAvailabilityExtRequestChoice_type0(com.cloudkey.pms.micros.ows.availability.RegionalAvailabilityExtRequestChoice_type0.Factory.parse(reader));
