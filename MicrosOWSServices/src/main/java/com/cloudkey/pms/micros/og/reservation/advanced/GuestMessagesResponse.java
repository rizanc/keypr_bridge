 ...
 */
            ...
            /**
            *  GuestMessagesResponse bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage[] localGuestMessages ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localGuestMessagesTracker = false ;

                           public boolean isGuestMessagesSpecified(){
                               return localGuestMessagesTracker;
                           }
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage[] getGuestMessages(){
                              ...
                              /**
                               * validate the array for GuestMessages
                               */
                              protected void validateGuestMessages(com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage[] param){
                              ...
                              */
                              public void setGuestMessages(com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage[] param){
                              
                                   validateGuestMessages(param);

                               localGuestMessagesTracker = param != null;
                             ...
                             * @param param com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage
                             */
                             public void addGuestMessages(com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage param){
                                   if (localGuestMessages == null){
                                   localGuestMessages = new com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage[]{};
                                   }

                            
                                 //update the setting tracker
                                localGuestMessagesTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localGuestMessages);
                               list.add(param);
                               this.localGuestMessages =
                             (com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage[])list.toArray(
                            new com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage[list.size()]);
       ...
       public org.apache.axiom.om.OMElement getOMElement (
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GuestMessagesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localGuestMessagesTracker){
                                       if (localGuestMessages!=null){
                                            for (int i = 0;i < localGuestMessages.length;i++){
                                                if (localGuestMessages[i] != null){
                                                 localGuestMessages[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","GuestMessages"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("GuestMessages cannot be null!!");
                                 ...
                                 for (int i = 0;i < localGuestMessages.length;i++){
                                    ...
                                    if (localGuestMessages[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/",
                                                                          "GuestMessages"));
                                         elementList.add(localGuestMessages[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static GuestMessagesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GuestMessagesResponse object =
                new GuestMessagesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GuestMessagesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GuestMessagesResponse)com.cloudkey.pms.micros.og.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","GuestMessages").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list1.add(com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","GuestMessages").equals(reader.getName())){
                                                                    list1.add(com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage.Factory.parse(reader));
                                                        ...
                                                        object.setGuestMessages((com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.og.reservation.advanced.GuestMessage.class,
                                                                list1));
