 ...
 */
            ...
            /**
            *  PackageEvents bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PackageEvents extends com.cloudkey.pms.micros.og.meetingroom.Event
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","PackageEvents"));
                 if (localMiscellaneousItemsTracker){
                             if (localMiscellaneousItems!=null) {
                                 for (int i = 0;i < localMiscellaneousItems.length;i++){
    ...
    public static class Factory{
        ...
        */
        public static PackageEvents parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PackageEvents object =
                new PackageEvents();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PackageEvents".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PackageEvents)com.cloudkey.pms.micros.og.meetingroom.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
