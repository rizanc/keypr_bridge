 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StatementReference",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StatementReference",
                           xmlWriter);
                                          ...
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localStatementDate is null");
                                      }
                                          ...
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localMembershipID is null");
                                                ...
                                                writeAttribute("",
                                                         "locked",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLocked), xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            new javax.xml.namespace.QName("","locked"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLocked));
    ...
    public static class Factory{
        ...
        */
        public static StatementReference parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StatementReference object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StatementReference".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StatementReference)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribStatementDate!=null){
                         java.lang.String content = tempAttribStatementDate;
                               ...
                               throw new org.apache.axis2.databinding.ADBException("Required attribute statementDate is missing");
                   ...
                   if (tempAttribMembershipID!=null){
                    ...
                    // handle attribute "locked"
                    java.lang.String tempAttribLocked =
                        
                                reader.getAttributeValue(null,"locked");
                            
                   if (tempAttribLocked!=null){
                         java.lang.String content = tempAttribLocked;
                        
                                                 object.setLocked(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(tempAttribLocked));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("locked");
