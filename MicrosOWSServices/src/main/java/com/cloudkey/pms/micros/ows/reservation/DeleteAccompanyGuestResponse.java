...
/**
 * DeleteAccompanyGuestResponse.java
 *
 ...
 */
            ...
            /**
            *  DeleteAccompanyGuestResponse bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = DeleteAccompanyGuestResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteAccompanyGuestResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static DeleteAccompanyGuestResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteAccompanyGuestResponse object =
                new DeleteAccompanyGuestResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteAccompanyGuestResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteAccompanyGuestResponse)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
