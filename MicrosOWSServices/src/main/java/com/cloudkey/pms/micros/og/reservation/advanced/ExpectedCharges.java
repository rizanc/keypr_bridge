 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for DailyCharges
                        */

                        
                                    protected com.cloudkey.pms.micros.og.hotelcommon.DailyChargeList localDailyCharges ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDailyChargesTracker = false ;

                           public boolean isDailyChargesSpecified(){
                               return localDailyChargesTracker;
                           }
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.hotelcommon.DailyChargeList getDailyCharges(){
                               return localDailyCharges;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DailyCharges
                               */
                               public void setDailyCharges(com.cloudkey.pms.micros.og.hotelcommon.DailyChargeList param){
                            localDailyChargesTracker = param != null;
                                   
                                            this.localDailyCharges=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ExpectedCharges",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ExpectedCharges",
                ...
                if (localTotalChargesTracker){
                                           ...
                                           localTotalCharges.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","TotalCharges"),
                                               xmlWriter);
                                           ...
                                           localCurrentBalance.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","CurrentBalance"),
                                               xmlWriter);
                                        } if (localDailyChargesTracker){
                                            if (localDailyCharges==null){
                                                 throw new org.apache.axis2.databinding.ADBException("DailyCharges cannot be null!!");
                                            }
                                           localDailyCharges.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","DailyCharges"),
                                               xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localTotalChargesTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/",
                                    ...
                                    elementList.add(localDailyCharges);
                                }
    ...
    public static class Factory{
        ...
        */
        public static ExpectedCharges parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExpectedCharges object =
                new ExpectedCharges();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ExpectedCharges".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ExpectedCharges)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","TotalCharges").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","CurrentBalance").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","DailyCharges").equals(reader.getName())){
                                
                                                object.setDailyCharges(com.cloudkey.pms.micros.og.hotelcommon.DailyChargeList.Factory.parse(reader));
