 ...
 */
            ...
            /**
            *  ProfileChoice_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ProfileChoice_type0
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ProfileChoice_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ProfileChoice_type0",
    ...
    public static class Factory{
        ...
        */
        public static ProfileChoice_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProfileChoice_type0 object =
                new ProfileChoice_type0();
