...
/**
 * FetchProfileBenefitsResponse.java
 *
 ...
 */
            ...
            /**
            *  FetchProfileBenefitsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FetchProfileBenefitsResponse
                ...
                "ns2");
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPromotionListTracker = false ;

                           public boolean isPromotionListSpecified(){
                               return localPromotionListTracker;
                           }
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localECertificateListTracker = false ;

                           public boolean isECertificateListSpecified(){
                               return localECertificateListTracker;
                           }
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FetchProfileBenefitsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FetchProfileBenefitsResponse",
                ...
                if (localResultTracker){
                                           ...
                                           localPromotionList.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Name.wsdl","PromotionList"),
                                               xmlWriter);
                                           ...
                                           localECertificateList.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Name.wsdl","ECertificateList"),
                                               xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localResultTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Name.wsdl",
                                    ...
                                    elementList.add(localPromotionList);
                                } if (localECertificateListTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Name.wsdl",
                                                                      "ECertificateList"));
                                    ...
                                    elementList.add(localECertificateList);
                                }
    ...
    public static class Factory{
        ...
        */
        public static FetchProfileBenefitsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FetchProfileBenefitsResponse object =
                new FetchProfileBenefitsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FetchProfileBenefitsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FetchProfileBenefitsResponse)com.cloudkey.pms.micros.ows.name.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
