 ...
 */
    ...
    public static class Factory{
                ...
                public static UDFCharacter fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    UDFCharacter returnValue = new  UDFCharacter();
                ...
                public static UDFCharacter fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return UDFCharacter.Factory.fromString(content,namespaceUri);
                    } else {
                       return UDFCharacter.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static UDFCharacter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UDFCharacter object =
                new UDFCharacter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UDFCharacter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UDFCharacter)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
