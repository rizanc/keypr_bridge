 ...
 */
            ...
            /**
            *  UpsellReservationRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns3");
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.common.UniqueID localUpsellOfferId ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.cloudkey.pms.micros.og.common.UniqueID
                           */
                           public  com.cloudkey.pms.micros.og.common.UniqueID getUpsellOfferId(){
                            ...
                            /**
                               ...
                               */
                               public void setUpsellOfferId(com.cloudkey.pms.micros.og.common.UniqueID param){
                            localUpsellOfferIdTracker = param != null;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpsellReservationRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpsellReservationRequest",
                ...
                if (localHotelReferenceTracker){
                                           ...
                                           localResvNameId.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl","ResvNameId"),
                                            ...
                                            if (localUpsellOfferId==null){
                                                 throw new org.apache.axis2.databinding.ADBException("UpsellOfferId cannot be null!!");
                                            }
                                           localUpsellOfferId.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl","UpsellOfferId"),
                                               xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localHotelReferenceTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl",
                                    ...
                                    elementList.add(localUpsellOfferId);
                                }
    ...
    public static class Factory{
        ...
        */
        public static UpsellReservationRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpsellReservationRequest object =
                new UpsellReservationRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpsellReservationRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpsellReservationRequest)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl","UpsellOfferId").equals(reader.getName())){
                                
                                                object.setUpsellOfferId(com.cloudkey.pms.micros.og.common.UniqueID.Factory.parse(reader));
