...
/**
 * CheckOutCompleteInvoiceNumber.java
 *
 ...
 */
            ...
            /**
            *  CheckOutCompleteInvoiceNumber bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CheckOutCompleteInvoiceNumber
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = CheckOutCompleteInvoiceNumber
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CheckOutCompleteInvoiceNumber",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CheckOutCompleteInvoiceNumber",
                           xmlWriter);
                   }
    ...
    public static class Factory{
                ...
                public static CheckOutCompleteInvoiceNumber fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    CheckOutCompleteInvoiceNumber returnValue = new  CheckOutCompleteInvoiceNumber();
                ...
                public static CheckOutCompleteInvoiceNumber fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return CheckOutCompleteInvoiceNumber.Factory.fromString(content,namespaceUri);
                    } else {
                       return CheckOutCompleteInvoiceNumber.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static CheckOutCompleteInvoiceNumber parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CheckOutCompleteInvoiceNumber object =
                new CheckOutCompleteInvoiceNumber();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CheckOutCompleteInvoiceNumber".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CheckOutCompleteInvoiceNumber)com.cloudkey.pms.micros.og.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribWindow!=null){
                         java.lang.String content = tempAttribWindow;
                                           ...
                                           object.setWindow(java.lang.Integer.MIN_VALUE);
