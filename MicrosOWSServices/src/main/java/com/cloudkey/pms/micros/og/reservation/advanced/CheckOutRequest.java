...
/**
        ...
        public  class CheckOutRequest extends CheckOutRequestE
	implements ADBBean{
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CheckOutRequest".equals(type)){
                                ...
                                return (CheckOutRequest)com.cloudkey.pms.micros.og.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
