 ...
 */
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.ows.information.LovQueryResultType[]
                           */
                           public  com.cloudkey.pms.micros.ows.information.LovQueryResultType[] getLovQueryResult(){
                               return localLovQueryResult;
                           }
                              ...
                              /**
                               * validate the array for LovQueryResult
                               */
                             ...
                             /**
                              * Auto generated setter method
                              * @param param LovQueryResult
                              */
                              public void setLovQueryResult(com.cloudkey.pms.micros.ows.information.LovQueryResultType[] param){
                             ...
                             * @param param com.cloudkey.pms.micros.ows.information.LovQueryResultType
                             */
                             public void addLovQueryResult(com.cloudkey.pms.micros.ows.information.LovQueryResultType param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localLovQueryResult);
                               list.add(param);
                               this.localLovQueryResult =
                             (com.cloudkey.pms.micros.ows.information.LovQueryResultType[])list.toArray(
                            new com.cloudkey.pms.micros.ows.information.LovQueryResultType[list.size()]);
                                       ...
                                       if (localLovQueryResult!=null){
                                            for (int i = 0;i < localLovQueryResult.length;i++){
                                                if (localLovQueryResult[i] != null){
                                                 localLovQueryResult[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","LovQueryResult"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static LovResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LovResponse object =
                new LovResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LovResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LovResponse)com.cloudkey.pms.micros.ows.information.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","LovQueryResult").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list2.add(com.cloudkey.pms.micros.ows.information.LovQueryResultType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","LovQueryResult").equals(reader.getName())){
                                                                    list2.add(com.cloudkey.pms.micros.ows.information.LovQueryResultType.Factory.parse(reader));
                                                        ...
                                                        object.setLovQueryResult((com.cloudkey.pms.micros.ows.information.LovQueryResultType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.ows.information.LovQueryResultType.class,
                                                                list2));
