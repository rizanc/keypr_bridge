...
/**
 * FetchAuthorizationsHistoryRequest.java
 *
 ...
 */
            ...
            /**
            *  FetchAuthorizationsHistoryRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "FetchAuthorizationsHistoryRequest",
                "ns6");
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.common.UniqueID localReservationID ;
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.common.UniqueID getReservationID(){
                            ...
                            /**
                               ...
                               */
                               public void setReservationID(com.cloudkey.pms.micros.og.common.UniqueID param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FetchAuthorizationsHistoryRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FetchAuthorizationsHistoryRequest",
    ...
    public static class Factory{
        ...
        */
        public static FetchAuthorizationsHistoryRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FetchAuthorizationsHistoryRequest object =
                new FetchAuthorizationsHistoryRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FetchAuthorizationsHistoryRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FetchAuthorizationsHistoryRequest)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","ReservationID").equals(reader.getName())){
                                                ...
                                                object.setReservationID(com.cloudkey.pms.micros.og.common.UniqueID.Factory.parse(reader));
