...
/**
 * MonitorQueueReservationsResponse.java
 *
 ...
 */
            ...
            /**
            *  MonitorQueueReservationsResponse bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "MonitorQueueReservationsResponse",
                "ns6");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MonitorQueueReservationsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MonitorQueueReservationsResponse",
    ...
    public static class Factory{
        ...
        */
        public static MonitorQueueReservationsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MonitorQueueReservationsResponse object =
                new MonitorQueueReservationsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MonitorQueueReservationsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MonitorQueueReservationsResponse)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
