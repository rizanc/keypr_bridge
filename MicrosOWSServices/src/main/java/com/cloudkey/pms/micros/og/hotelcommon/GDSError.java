 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected java.lang.String localElementId ;
                           ...
                           */
                           public  java.lang.String getElementId(){
                            ...
                            /**
                               ...
                               */
                               public void setElementId(java.lang.String param){
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","elementId"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localElementId));
    ...
    public static class Factory{
                ...
                public static GDSError fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    GDSError returnValue = new  GDSError();
                ...
                public static GDSError fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return GDSError.Factory.fromString(content,namespaceUri);
                    } else {
                       return GDSError.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static GDSError parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GDSError object =
                new GDSError();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GDSError".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GDSError)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribErrorCode!=null){
                         java.lang.String content = tempAttribErrorCode;
                                                 ...
                                                 object.setErrorCode(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribErrorCode));
                    ...
                    // handle attribute "elementId"
                    java.lang.String tempAttribElementId =
                        
                                reader.getAttributeValue(null,"elementId");
                            
                   if (tempAttribElementId!=null){
                         java.lang.String content = tempAttribElementId;
                        
                                                 object.setElementId(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribElementId));
