 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RegionalSearch",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RegionalSearch",
    ...
    public static class Factory{
        ...
        */
        public static RegionalSearch parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RegionalSearch object =
                new RegionalSearch();
