 ...
 */
            ...
            /**
            *  PhoneData_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PhoneData_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PhoneData_type0
                ...
                */
                        ...
                        /**
                        * field for CountryAccessCode
                        * This was an Attribute!
                        */

                        
                                    protected java.lang.String localCountryAccessCode ;
                           ...
                           */
                           public  java.lang.String getCountryAccessCode(){
                            ...
                            /**
                               ...
                               * @param param CountryAccessCode
                               */
                               public void setCountryAccessCode(java.lang.String param){
                            
                                            this.localCountryAccessCode=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PhoneData_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PhoneData_type0",
                           xmlWriter);
                                            ...
                                            if (localCountryAccessCode != null){
                                        
                                                writeAttribute("",
                                                         "countryAccessCode",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCountryAccessCode), xmlWriter);
                                            ...
                                            if (localAreaCode != null){
                                                ...
                                                writeAttribute("",
                                                         "areaCode",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAreaCode), xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","countryAccessCode"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCountryAccessCode));
                                
                            attribList.add(
                            new javax.xml.namespace.QName("","areaCode"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAreaCode));
    ...
    public static class Factory{
        ...
        */
        public static PhoneData_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PhoneData_type0 object =
                new PhoneData_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PhoneData_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PhoneData_type0)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    // handle attribute "countryAccessCode"
                    java.lang.String tempAttribCountryAccessCode =
                        
                                reader.getAttributeValue(null,"countryAccessCode");
                            
                   if (tempAttribCountryAccessCode!=null){
                         java.lang.String content = tempAttribCountryAccessCode;
                        
                                                 object.setCountryAccessCode(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribCountryAccessCode));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("countryAccessCode");
                    
                    // handle attribute "areaCode"
                    java.lang.String tempAttribAreaCode =
                        
                                reader.getAttributeValue(null,"areaCode");
                            
                   if (tempAttribAreaCode!=null){
                         java.lang.String content = tempAttribAreaCode;
                        
                                                 object.setAreaCode(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribAreaCode));
