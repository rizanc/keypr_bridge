 ...
 */
    ...
    public static class Factory{
                ...
                public static UDFDate fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    UDFDate returnValue = new  UDFDate();
                ...
                public static UDFDate fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return UDFDate.Factory.fromString(content,namespaceUri);
                    } else {
                       return UDFDate.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static UDFDate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UDFDate object =
                new UDFDate();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UDFDate".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UDFDate)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
