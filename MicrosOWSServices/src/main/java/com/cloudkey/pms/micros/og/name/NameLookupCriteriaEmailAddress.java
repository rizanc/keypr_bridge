...
/**
 * NameLookupCriteriaEmailAddress.java
 *
 ...
 */
            ...
            /**
            *  NameLookupCriteriaEmailAddress bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = NameLookupCriteriaEmailAddress
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NameLookupCriteriaEmailAddress",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NameLookupCriteriaEmailAddress",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static NameLookupCriteriaEmailAddress parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NameLookupCriteriaEmailAddress object =
                new NameLookupCriteriaEmailAddress();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NameLookupCriteriaEmailAddress".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NameLookupCriteriaEmailAddress)com.cloudkey.pms.micros.ows.name.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
