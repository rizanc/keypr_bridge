 ...
 */
            ...
            /**
            *  ArrayOfPhone1 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ArrayOfPhone1
                                       ...
                                       if (localPhone!=null){
                                            for (int i = 0;i < localPhone.length;i++){
                                                if (localPhone[i] != null){
                                                 localPhone[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/HotelCommon/","Phone"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://webservices.micros.com/og/4.3/HotelCommon/", "Phone", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static ArrayOfPhone1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ArrayOfPhone1 object =
                new ArrayOfPhone1();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ArrayOfPhone1".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ArrayOfPhone1)com.cloudkey.pms.micros.ows.information.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/HotelCommon/","Phone").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list1.add(com.cloudkey.pms.micros.og.common.Phone.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/HotelCommon/","Phone").equals(reader.getName())){
