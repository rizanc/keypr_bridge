 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.reservation.BillHeader[] getInvoice(){
                               ...
                               */
                              protected void validateInvoice(com.cloudkey.pms.micros.og.reservation.BillHeader[] param){
                             ...
                             * @param param com.cloudkey.pms.micros.og.reservation.BillHeader
                             */
                             public void addInvoice(com.cloudkey.pms.micros.og.reservation.BillHeader param){
                                   if (localInvoice == null){
                                   localInvoice = new com.cloudkey.pms.micros.og.reservation.BillHeader[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localInvoice);
                               list.add(param);
                               this.localInvoice =
                             (com.cloudkey.pms.micros.og.reservation.BillHeader[])list.toArray(
                            new com.cloudkey.pms.micros.og.reservation.BillHeader[list.size()]);
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.reservation.advanced.ExpectedCharges localExpectedCharges ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.reservation.advanced.ExpectedCharges
                           */
                           public  com.cloudkey.pms.micros.og.reservation.advanced.ExpectedCharges getExpectedCharges(){
                            ...
                            /**
                               ...
                               */
                               public void setExpectedCharges(com.cloudkey.pms.micros.og.reservation.advanced.ExpectedCharges param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InvoiceResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "InvoiceResponse",
                                       ...
                                       if (localInvoice!=null){
                                            for (int i = 0;i < localInvoice.length;i++){
                                                if (localInvoice[i] != null){
                                                 localInvoice[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","Invoice"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static InvoiceResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","Invoice").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list1.add(com.cloudkey.pms.micros.og.reservation.BillHeader.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","Invoice").equals(reader.getName())){
                                                                    list1.add(com.cloudkey.pms.micros.og.reservation.BillHeader.Factory.parse(reader));
                                                        ...
                                                        object.setInvoice((com.cloudkey.pms.micros.og.reservation.BillHeader[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.og.reservation.BillHeader.class,
                                                                list1));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","ExpectedCharges").equals(reader.getName())){
                                
                                                object.setExpectedCharges(com.cloudkey.pms.micros.og.reservation.advanced.ExpectedCharges.Factory.parse(reader));
