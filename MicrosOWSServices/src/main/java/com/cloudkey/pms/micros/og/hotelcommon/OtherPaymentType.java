 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OtherPaymentType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "OtherPaymentType",
    ...
    public static class Factory{
        ...
        */
        public static OtherPaymentType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OtherPaymentType object =
                new OtherPaymentType();
