 ...
 */
    ...
    public static class Factory{
                ...
                public static UDFNumeric fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    UDFNumeric returnValue = new  UDFNumeric();
                ...
                public static UDFNumeric fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return UDFNumeric.Factory.fromString(content,namespaceUri);
                    } else {
                       return UDFNumeric.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static UDFNumeric parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UDFNumeric object =
                new UDFNumeric();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UDFNumeric".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UDFNumeric)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
