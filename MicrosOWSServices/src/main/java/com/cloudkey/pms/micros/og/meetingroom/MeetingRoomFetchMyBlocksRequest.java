...
/**
 * MeetingRoomFetchMyBlocksRequest.java
 *
 ...
 */
            ...
            /**
            *  MeetingRoomFetchMyBlocksRequest bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = MeetingRoomFetchMyBlocksRequest
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.common.UniqueID localContactNameID ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localContactNameIDTracker = false ;

                           public boolean isContactNameIDSpecified(){
                               return localContactNameIDTracker;
                           }
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.common.UniqueID getContactNameID(){
                            ...
                            /**
                               ...
                               */
                               public void setContactNameID(com.cloudkey.pms.micros.og.common.UniqueID param){
                            localContactNameIDTracker = param != null;
                        ...
                        /**
                        * field for AccountNameID
                        */

                        
                                    protected com.cloudkey.pms.micros.og.common.UniqueID localAccountNameID ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAccountNameIDTracker = false ;

                           public boolean isAccountNameIDSpecified(){
                               return localAccountNameIDTracker;
                           }
                           ...
                           * @return com.cloudkey.pms.micros.og.common.UniqueID
                           */
                           public  com.cloudkey.pms.micros.og.common.UniqueID getAccountNameID(){
                               return localAccountNameID;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param AccountNameID
                               */
                               public void setAccountNameID(com.cloudkey.pms.micros.og.common.UniqueID param){
                            localAccountNameIDTracker = param != null;
                                   
                                            this.localAccountNameID=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MeetingRoomFetchMyBlocksRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localHotelReferenceTracker){
                                           ...
                                           localHotelReference.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","HotelReference"),
                                               xmlWriter);
                                        } if (localContactNameIDTracker){
                                            if (localContactNameID==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ContactNameID cannot be null!!");
                                            }
                                           localContactNameID.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","ContactNameID"),
                                               xmlWriter);
                                        } if (localAccountNameIDTracker){
                                            if (localAccountNameID==null){
                                                 throw new org.apache.axis2.databinding.ADBException("AccountNameID cannot be null!!");
                                            }
                                           localAccountNameID.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","AccountNameID"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localHotelReferenceTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/",
                                    ...
                                    elementList.add(localContactNameID);
                                } if (localAccountNameIDTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/",
                                                                      "AccountNameID"));
                                    ...
                                    elementList.add(localAccountNameID);
                                } if (localBlockDateTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/",
                                                                      "BlockDate"));
    ...
    public static class Factory{
        ...
        */
        public static MeetingRoomFetchMyBlocksRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MeetingRoomFetchMyBlocksRequest object =
                new MeetingRoomFetchMyBlocksRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MeetingRoomFetchMyBlocksRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MeetingRoomFetchMyBlocksRequest)com.cloudkey.pms.micros.og.meetingroom.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","ContactNameID").equals(reader.getName())){
                                
                                                object.setContactNameID(com.cloudkey.pms.micros.og.common.UniqueID.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","AccountNameID").equals(reader.getName())){
                                
                                                object.setAccountNameID(com.cloudkey.pms.micros.og.common.UniqueID.Factory.parse(reader));
