 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":BookedPackageEvent",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "BookedPackageEvent",
    ...
    public static class Factory{
        ...
        */
        public static BookedPackageEvent parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BookedPackageEvent object =
                new BookedPackageEvent();
