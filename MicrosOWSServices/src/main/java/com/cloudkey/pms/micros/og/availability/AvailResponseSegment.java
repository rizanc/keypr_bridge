 ...
 */
            ...
            /**
            *  AvailResponseSegment bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected java.lang.String localAdditionalInformation ;
                           ...
                           */
                           public  java.lang.String getAdditionalInformation(){
                            ...
                            /**
                               ...
                               */
                               public void setAdditionalInformation(java.lang.String param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AvailResponseSegment",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                    ...
                                    writeStartElement(null, namespace, "AdditionalInformation", xmlWriter);
                                          ...
                                          if (localAdditionalInformation==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localAdditionalInformation);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Availability/",
                                    ...
                                    elementList.add(localRoomStayList);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Availability/",
                                        ...
                                        if (localAdditionalInformation != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAdditionalInformation));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("AdditionalInformation cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static AvailResponseSegment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AvailResponseSegment object =
                new AvailResponseSegment();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AvailResponseSegment".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AvailResponseSegment)com.cloudkey.pms.micros.ows.availability.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribMoreDataEchoToken!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Availability/","AdditionalInformation").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"AdditionalInformation" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setAdditionalInformation(
