 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.name.KeyWord[] getKeyWord(){
                               ...
                               */
                              protected void validateKeyWord(com.cloudkey.pms.micros.og.name.KeyWord[] param){
                             ...
                             * @param param com.cloudkey.pms.micros.og.name.KeyWord
                             */
                             public void addKeyWord(com.cloudkey.pms.micros.og.name.KeyWord param){
                                   if (localKeyWord == null){
                                   localKeyWord = new com.cloudkey.pms.micros.og.name.KeyWord[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localKeyWord);
                               list.add(param);
                               this.localKeyWord =
                             (com.cloudkey.pms.micros.og.name.KeyWord[])list.toArray(
                            new com.cloudkey.pms.micros.og.name.KeyWord[list.size()]);
                                       ...
                                       if (localKeyWord!=null){
                                            for (int i = 0;i < localKeyWord.length;i++){
                                                if (localKeyWord[i] != null){
                                                 localKeyWord[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Name/","KeyWord"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static KeyWordList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            KeyWordList object =
                new KeyWordList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"KeyWordList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (KeyWordList)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(com.cloudkey.pms.micros.og.name.KeyWord.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Name/","KeyWord").equals(reader.getName())){
                                                                    list1.add(com.cloudkey.pms.micros.og.name.KeyWord.Factory.parse(reader));
                                                        ...
                                                        object.setKeyWord((com.cloudkey.pms.micros.og.name.KeyWord[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.og.name.KeyWord.class,
                                                                list1));
