 ...
 */
            ...
            /**
            *  ScreenItemsResponse bean class
            */
                ...
                "ns6");
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isScreenNameSpecified(){
                               return localScreenNameTracker;
                           }
                           ...
                           */
                           public  java.lang.String getScreenName(){
                            ...
                            localScreenNameTracker = param != null;
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localScreenItemsTracker = false ;

                           public boolean isScreenItemsSpecified(){
                               return localScreenItemsTracker;
                           }
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ScreenItemsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ScreenItemsResponse",
                           xmlWriter);
                                    ...
                                    writeStartElement(null, namespace, "ScreenName", xmlWriter);
                                          ...
                                          if (localScreenName==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("ScreenName cannot be null!!");
                             ...
                             } if (localScreenItemsTracker){
                                            if (localScreenItems==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ScreenItems cannot be null!!");
                                            }
                                           localScreenItems.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","ScreenItems"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl",
                                 ...
                                 if (localScreenNameTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl",
                                        ...
                                        if (localScreenName != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localScreenName));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("ScreenName cannot be null!!");
                                        }
                                    } if (localScreenItemsTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl",
                                    ...
                                    elementList.add(localScreenItems);
                                }
    ...
    public static class Factory{
        ...
        */
        public static ScreenItemsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ScreenItemsResponse object =
                new ScreenItemsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ScreenItemsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ScreenItemsResponse)com.cloudkey.pms.micros.ows.information.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","ScreenName").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"ScreenName" +"  cannot be null");
                                    }
