 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VaultedCardType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VaultedCardType",
    ...
    public static class Factory{
        ...
        */
        public static VaultedCardType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VaultedCardType object =
                new VaultedCardType();
