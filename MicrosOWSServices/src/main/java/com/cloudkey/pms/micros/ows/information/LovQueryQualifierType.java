 ...
 */
            ...
            /**
            *  LovQueryQualifierType bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LovQueryQualifierType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "LovQueryQualifierType",
                           xmlWriter);
                   }
                                          ...
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localQualifierType is null");
                                      }
    ...
    public static class Factory{
                ...
                public static LovQueryQualifierType fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    LovQueryQualifierType returnValue = new  LovQueryQualifierType();
                ...
                public static LovQueryQualifierType fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return LovQueryQualifierType.Factory.fromString(content,namespaceUri);
                    } else {
                       return LovQueryQualifierType.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static LovQueryQualifierType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LovQueryQualifierType object =
                new LovQueryQualifierType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LovQueryQualifierType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LovQueryQualifierType)com.cloudkey.pms.micros.ows.information.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribQualifierType!=null){
                         java.lang.String content = tempAttribQualifierType;
                               ...
                               throw new org.apache.axis2.databinding.ADBException("Required attribute qualifierType is missing");
