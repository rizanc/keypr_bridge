...
/**
 * MeetingRegisterEventAttendeesRequest.java
 *
 ...
 */
            ...
            /**
            *  MeetingRegisterEventAttendeesRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns7");
                        ...
                        */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.meetingroom.EventAttendee[]
                           */
                           public  com.cloudkey.pms.micros.og.meetingroom.EventAttendee[] getEventAttendees(){
                              ...
                              /**
                               * validate the array for EventAttendees
                               */
                             ...
                             /**
                              * Auto generated setter method
                              * @param param EventAttendees
                              */
                              public void setEventAttendees(com.cloudkey.pms.micros.og.meetingroom.EventAttendee[] param){
                             ...
                             * @param param com.cloudkey.pms.micros.og.meetingroom.EventAttendee
                             */
                             public void addEventAttendees(com.cloudkey.pms.micros.og.meetingroom.EventAttendee param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localEventAttendees);
                               list.add(param);
                               this.localEventAttendees =
                             (com.cloudkey.pms.micros.og.meetingroom.EventAttendee[])list.toArray(
                            new com.cloudkey.pms.micros.og.meetingroom.EventAttendee[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MeetingRegisterEventAttendeesRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MeetingRegisterEventAttendeesRequest",
                                       ...
                                       if (localEventAttendees!=null){
                                            for (int i = 0;i < localEventAttendees.length;i++){
                                                if (localEventAttendees[i] != null){
                                                 localEventAttendees[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventAttendees"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static MeetingRegisterEventAttendeesRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MeetingRegisterEventAttendeesRequest object =
                new MeetingRegisterEventAttendeesRequest();
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventAttendees").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list2.add(com.cloudkey.pms.micros.og.meetingroom.EventAttendee.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventAttendees").equals(reader.getName())){
                                                                    list2.add(com.cloudkey.pms.micros.og.meetingroom.EventAttendee.Factory.parse(reader));
                                                        ...
                                                        object.setEventAttendees((com.cloudkey.pms.micros.og.meetingroom.EventAttendee[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.og.meetingroom.EventAttendee.class,
                                                                list2));
