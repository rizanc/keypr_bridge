 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PrivacyOptionType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PrivacyOptionType",
                           xmlWriter);
                                    ...
                                    if (localOptionType != null){
                                        writeAttribute("",
                                           "OptionType",
                                           localOptionType.toString(), xmlWriter);
                                    }
                                    
                                      else {
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localOptionType is null");
                                      }
                                    ...
                                    if (localOptionValue != null){
                                        writeAttribute("",
                                           "OptionValue",
                                           localOptionValue.toString(), xmlWriter);
                                    }
                                    
                                      else {
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localOptionValue is null");
                                      }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","OptionType"));
                            
                                      attribList.add(localOptionType.toString());
                                
                            attribList.add(
                            new javax.xml.namespace.QName("","OptionValue"));
                            
                                      attribList.add(localOptionValue.toString());
    ...
    public static class Factory{
        ...
        */
        public static PrivacyOptionType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PrivacyOptionType object =
                new PrivacyOptionType();
            ...
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    // handle attribute "OptionType"
                    java.lang.String tempAttribOptionType =
                        
                                reader.getAttributeValue(null,"OptionType");
                            
                   if (tempAttribOptionType!=null){
                         java.lang.String content = tempAttribOptionType;
                               ...
                               throw new org.apache.axis2.databinding.ADBException("Required attribute OptionType is missing");
                           
                    }
                    handledAttributes.add("OptionType");
                    
                    // handle attribute "OptionValue"
                    java.lang.String tempAttribOptionValue =
                        
                                reader.getAttributeValue(null,"OptionValue");
                            
                   if (tempAttribOptionValue!=null){
                         java.lang.String content = tempAttribOptionValue;
                               ...
                               throw new org.apache.axis2.databinding.ADBException("Required attribute OptionValue is missing");
                           
                    }
                    handledAttributes.add("OptionValue");
