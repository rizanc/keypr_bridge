...
/**
 * FetchBookingForPointUpdateResponse.java
 *
 ...
 */
            ...
            /**
            *  FetchBookingForPointUpdateResponse bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = FetchBookingForPointUpdateResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FetchBookingForPointUpdateResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static FetchBookingForPointUpdateResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FetchBookingForPointUpdateResponse object =
                new FetchBookingForPointUpdateResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FetchBookingForPointUpdateResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FetchBookingForPointUpdateResponse)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
