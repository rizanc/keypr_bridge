...
/**
 * UpdateEnrollmentCodeRequest.java
 *
 ...
 */
            ...
            /**
            *  UpdateEnrollmentCodeRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateEnrollmentCodeRequest
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = UpdateEnrollmentCodeRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateEnrollmentCodeRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static UpdateEnrollmentCodeRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateEnrollmentCodeRequest object =
                new UpdateEnrollmentCodeRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateEnrollmentCodeRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateEnrollmentCodeRequest)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
