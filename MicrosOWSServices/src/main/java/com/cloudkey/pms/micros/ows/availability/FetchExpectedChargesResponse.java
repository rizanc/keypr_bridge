...
/**
 * FetchExpectedChargesResponse.java
 *
 ...
 */
            ...
            /**
            *  FetchExpectedChargesResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FetchExpectedChargesResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://webservices.micros.com/ows/5.1/Availability.wsdl",
                "FetchExpectedChargesResponse",
                "ns7");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FetchExpectedChargesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FetchExpectedChargesResponse",
                           xmlWriter);
                                         ...
                                         if (localExpectedChargesTracker){
                                           ...
                                           localExpectedCharges.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Availability.wsdl","ExpectedCharges"),
                                               xmlWriter);
                                        }
    ...
    public static class Factory{
        ...
        */
        public static FetchExpectedChargesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FetchExpectedChargesResponse object =
                new FetchExpectedChargesResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FetchExpectedChargesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FetchExpectedChargesResponse)com.cloudkey.pms.micros.ows.availability.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Availability.wsdl","ExpectedCharges").equals(reader.getName())){
