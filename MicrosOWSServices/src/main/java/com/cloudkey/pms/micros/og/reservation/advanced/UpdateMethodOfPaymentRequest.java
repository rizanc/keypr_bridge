...
/**
 * UpdateMethodOfPaymentRequest.java
 *
 ...
 */
            ...
            /**
            *  UpdateMethodOfPaymentRequest bean class
            */
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo[]
                           */
                           public  com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo[] getMethodOfPayment(){
                               return localMethodOfPayment;
                           }
                              ...
                              /**
                               * validate the array for MethodOfPayment
                               */
                             ...
                             /**
                              * Auto generated setter method
                              * @param param MethodOfPayment
                              */
                              public void setMethodOfPayment(com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo[] param){
                             ...
                             * @param param com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo
                             */
                             public void addMethodOfPayment(com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localMethodOfPayment);
                               list.add(param);
                               this.localMethodOfPayment =
                             (com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo[])list.toArray(
                            new com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateMethodOfPaymentRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                       ...
                                       if (localMethodOfPayment!=null){
                                            for (int i = 0;i < localMethodOfPayment.length;i++){
                                                if (localMethodOfPayment[i] != null){
                                                 localMethodOfPayment[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","MethodOfPayment"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static UpdateMethodOfPaymentRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateMethodOfPaymentRequest object =
                new UpdateMethodOfPaymentRequest();
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","MethodOfPayment").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list2.add(com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","MethodOfPayment").equals(reader.getName())){
                                                                    list2.add(com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo.Factory.parse(reader));
                                                        ...
                                                        object.setMethodOfPayment((com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.og.reservation.advanced.MethodOfPaymentInfo.class,
                                                                list2));
