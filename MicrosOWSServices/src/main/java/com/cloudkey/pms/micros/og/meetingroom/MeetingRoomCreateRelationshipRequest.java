...
/**
 * MeetingRoomCreateRelationshipRequest.java
 *
 ...
 */
            ...
            /**
            *  MeetingRoomCreateRelationshipRequest bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = MeetingRoomCreateRelationshipRequest
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.meetingroom.ProfileData localFrom ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.meetingroom.ProfileData
                           */
                           public  com.cloudkey.pms.micros.og.meetingroom.ProfileData getFrom(){
                               return localFrom;
                           }
                            ...
                            /**
                               ...
                               * @param param From
                               */
                               public void setFrom(com.cloudkey.pms.micros.og.meetingroom.ProfileData param){
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.meetingroom.ProfileData localTo ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.cloudkey.pms.micros.og.meetingroom.ProfileData
                           */
                           public  com.cloudkey.pms.micros.og.meetingroom.ProfileData getTo(){
                               return localTo;
                           }
                            ...
                            /**
                               ...
                               * @param param To
                               */
                               public void setTo(com.cloudkey.pms.micros.og.meetingroom.ProfileData param){
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MeetingRoomCreateRelationshipRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localHotelReferenceTracker){
                                           ...
                                           localFrom.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","From"),
                                               xmlWriter);
                                        } if (localToTracker){
                                            if (localTo==null){
                                                 throw new org.apache.axis2.databinding.ADBException("To cannot be null!!");
                                            }
                                           localTo.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","To"),
                                               xmlWriter);
                                        }
    ...
    public static class Factory{
        ...
        */
        public static MeetingRoomCreateRelationshipRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MeetingRoomCreateRelationshipRequest object =
                new MeetingRoomCreateRelationshipRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MeetingRoomCreateRelationshipRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MeetingRoomCreateRelationshipRequest)com.cloudkey.pms.micros.og.meetingroom.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","From").equals(reader.getName())){
                                
                                                object.setFrom(com.cloudkey.pms.micros.og.meetingroom.ProfileData.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","To").equals(reader.getName())){
                                
                                                object.setTo(com.cloudkey.pms.micros.og.meetingroom.ProfileData.Factory.parse(reader));
