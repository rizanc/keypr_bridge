 ...
 */
            ...
            /**
            *  AwardsSchedulesRequest bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for PropertyCode
                        */

                        
                                    protected java.lang.String localPropertyCode ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPropertyCodeTracker = false ;

                           public boolean isPropertyCodeSpecified(){
                               return localPropertyCodeTracker;
                           }
                           ...
                           */
                           public  java.lang.String getPropertyCode(){
                            ...
                            /**
                               ...
                               * @param param PropertyCode
                               */
                               public void setPropertyCode(java.lang.String param){
                            localPropertyCodeTracker = param != null;
                                   
                                            this.localPropertyCode=param;
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.membership.AwardType localAwardType ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.membership.AwardType
                           */
                           public  com.cloudkey.pms.micros.og.membership.AwardType getAwardType(){
                            ...
                            /**
                               ...
                               */
                               public void setAwardType(com.cloudkey.pms.micros.og.membership.AwardType param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AwardsSchedulesRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AwardsSchedulesRequest",
                           xmlWriter);
                   }

               
                   }
                if (localPropertyCodeTracker){
                                    namespace = "http://webservices.micros.com/ows/5.1/Information.wsdl";
                                    writeStartElement(null, namespace, "PropertyCode", xmlWriter);
                             

                                          if (localPropertyCode==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("PropertyCode cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localPropertyCode);
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localAwardType.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","AwardType"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localPropertyCodeTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl",
                                        ...
                                        if (localPropertyCode != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPropertyCode));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("PropertyCode cannot be null!!");
                                        }
                                    }
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl",
                                    ...
                                    elementList.add(localAwardType);
                                 if (localMembershipLevelTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl",
                                                                      "MembershipLevel"));
    ...
    public static class Factory{
        ...
        */
        public static AwardsSchedulesRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AwardsSchedulesRequest object =
                new AwardsSchedulesRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AwardsSchedulesRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AwardsSchedulesRequest)com.cloudkey.pms.micros.ows.information.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","PropertyCode").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"PropertyCode" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setPropertyCode(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","AwardType").equals(reader.getName())){
                                
                                                object.setAwardType(com.cloudkey.pms.micros.og.membership.AwardType.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","MembershipLevel").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","MembershipType").equals(reader.getName())){
