 ...
 */
    ...
    public static class Factory{
                ...
                public static LovValueType fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    LovValueType returnValue = new  LovValueType();
                ...
                public static LovValueType fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return LovValueType.Factory.fromString(content,namespaceUri);
                    } else {
                       return LovValueType.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static LovValueType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LovValueType object =
                new LovValueType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LovValueType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LovValueType)com.cloudkey.pms.micros.ows.information.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
