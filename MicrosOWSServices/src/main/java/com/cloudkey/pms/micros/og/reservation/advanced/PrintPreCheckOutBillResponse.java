...
/**
 * PrintPreCheckOutBillResponse.java
 *
 ...
 */
            ...
            /**
            *  PrintPreCheckOutBillResponse bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = PrintPreCheckOutBillResponse
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for DocumentsToSign
                        * This was an Array!
                        */

                        
                                    protected com.cloudkey.pms.micros.og.common.FileData[] localDocumentsToSign ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDocumentsToSignTracker = false ;

                           public boolean isDocumentsToSignSpecified(){
                               return localDocumentsToSignTracker;
                           }
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.common.FileData[] getDocumentsToSign(){
                               return localDocumentsToSign;
                           }
                              ...
                              /**
                               * validate the array for DocumentsToSign
                               */
                              protected void validateDocumentsToSign(com.cloudkey.pms.micros.og.common.FileData[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param DocumentsToSign
                              */
                              public void setDocumentsToSign(com.cloudkey.pms.micros.og.common.FileData[] param){
                              
                                   validateDocumentsToSign(param);

                               localDocumentsToSignTracker = param != null;
                                      
                                      this.localDocumentsToSign=param;
                              }
                             ...
                             */
                             public void addDocumentsToSign(com.cloudkey.pms.micros.og.common.FileData param){
                                   if (localDocumentsToSign == null){
                                   localDocumentsToSign = new com.cloudkey.pms.micros.og.common.FileData[]{};
                                   }

                            
                                 //update the setting tracker
                                localDocumentsToSignTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localDocumentsToSign);
                               list.add(param);
                               this.localDocumentsToSign =
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PrintPreCheckOutBillResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                   ...
                                   for (int i = 0;i < localGuestBill.length;i++){
                                         ...
                                         throw new org.apache.axis2.databinding.ADBException("GuestBill cannot be null!!");
                                           ...
                                           localResult.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","Result"),
                                               xmlWriter);
                                        } if (localDocumentsToSignTracker){
                                       if (localDocumentsToSign!=null){
                                            for (int i = 0;i < localDocumentsToSign.length;i++){
                                                if (localDocumentsToSign[i] != null){
                                                 localDocumentsToSign[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","DocumentsToSign"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("DocumentsToSign cannot be null!!");
                             ...
                             if (localDocumentsToSign!=null) {
                                 for (int i = 0;i < localDocumentsToSign.length;i++){
                                    ...
                                    if (localDocumentsToSign[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/",
                                                                          "DocumentsToSign"));
                                         elementList.add(localDocumentsToSign[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static PrintPreCheckOutBillResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PrintPreCheckOutBillResponse object =
                new PrintPreCheckOutBillResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PrintPreCheckOutBillResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PrintPreCheckOutBillResponse)com.cloudkey.pms.micros.og.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","DocumentsToSign").equals(reader.getName())){
                                    ...
                                    list4.add(com.cloudkey.pms.micros.og.common.FileData.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","DocumentsToSign").equals(reader.getName())){
                                                                    list4.add(com.cloudkey.pms.micros.og.common.FileData.Factory.parse(reader));
                                                        ...
                                                        object.setDocumentsToSign((com.cloudkey.pms.micros.og.common.FileData[])
