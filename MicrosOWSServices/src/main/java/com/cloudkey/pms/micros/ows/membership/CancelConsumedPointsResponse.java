...
/**
 * CancelConsumedPointsResponse.java
 *
 ...
 */
            ...
            /**
            *  CancelConsumedPointsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CancelConsumedPointsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CancelConsumedPointsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CancelConsumedPointsResponse",
    ...
    public static class Factory{
        ...
        */
        public static CancelConsumedPointsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CancelConsumedPointsResponse object =
                new CancelConsumedPointsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CancelConsumedPointsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CancelConsumedPointsResponse)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
