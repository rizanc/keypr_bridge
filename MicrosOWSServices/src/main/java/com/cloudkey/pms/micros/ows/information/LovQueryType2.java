 ...
 */
                ...
                */
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String getLovIdentifier(){
                               return localLovIdentifier;
                           }
                                    ...
                                    writeStartElement(null, namespace, "LovIdentifier", xmlWriter);
                                          ...
                                          if (localLovIdentifier==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localLovIdentifier);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localLovIdentifierTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl",
                                        ...
                                        if (localLovIdentifier != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLovIdentifier));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("LovIdentifier cannot be null!!");
                                        }
                                    } if (localLovQueryQualifierTracker){
    ...
    public static class Factory{
        ...
        */
        public static LovQueryType2 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LovQueryType2 object =
                new LovQueryType2();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LovQueryType2".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LovQueryType2)com.cloudkey.pms.micros.ows.information.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Information.wsdl","LovIdentifier").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"LovIdentifier" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setLovIdentifier(
                                    ...
                                    list2.add(com.cloudkey.pms.micros.ows.information.LovQueryQualifierType.Factory.parse(reader));
