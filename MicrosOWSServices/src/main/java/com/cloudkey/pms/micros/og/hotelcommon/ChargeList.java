 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.hotelcommon.Charge[] localCharges ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.hotelcommon.Charge[] getCharges(){
                               return localCharges;
                           }
                              ...
                              /**
                               * validate the array for Charges
                               */
                              protected void validateCharges(com.cloudkey.pms.micros.og.hotelcommon.Charge[] param){
                              ...
                              * @param param Charges
                              */
                              public void setCharges(com.cloudkey.pms.micros.og.hotelcommon.Charge[] param){
                              
                                   validateCharges(param);
                             ...
                             */
                             public void addCharges(com.cloudkey.pms.micros.og.hotelcommon.Charge param){
                                   if (localCharges == null){
                                   localCharges = new com.cloudkey.pms.micros.og.hotelcommon.Charge[]{};
                                   }

                            
                                 //update the setting tracker
                                localChargesTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localCharges);
                               list.add(param);
                               this.localCharges =
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                     ...
                                     if (localChargesTracker){
                                       if (localCharges!=null){
                                            for (int i = 0;i < localCharges.length;i++){
                                                if (localCharges[i] != null){
                                                 localCharges[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/HotelCommon/","Charges"),
                                                           xmlWriter);
                                                } else {
                                 ...
                                 for (int i = 0;i < localCharges.length;i++){
                                    ...
                                    if (localCharges[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/HotelCommon/",
                                                                          "Charges"));
                                         elementList.add(localCharges[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static ChargeList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ChargeList object =
                new ChargeList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ChargeList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ChargeList)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribDecimals!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/HotelCommon/","Charges").equals(reader.getName())){
                                    ...
                                    list1.add(com.cloudkey.pms.micros.og.hotelcommon.Charge.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/HotelCommon/","Charges").equals(reader.getName())){
                                                                    list1.add(com.cloudkey.pms.micros.og.hotelcommon.Charge.Factory.parse(reader));
                                                        ...
                                                        object.setCharges((com.cloudkey.pms.micros.og.hotelcommon.Charge[])
