 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.common.UniqueID[] getEventID(){
                              ...
                              /**
                               * validate the array for EventID
                               */
                             ...
                             */
                             public void addEventID(com.cloudkey.pms.micros.og.common.UniqueID param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localEventID);
                               list.add(param);
                               this.localEventID =
                                       ...
                                       if (localEventID!=null){
                                            for (int i = 0;i < localEventID.length;i++){
                                                if (localEventID[i] != null){
                                                 localEventID[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventID"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static EventAttendee parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                   ...
                   if (tempAttribActionType!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list2.add(com.cloudkey.pms.micros.og.common.UniqueID.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventID").equals(reader.getName())){
                                                                    list2.add(com.cloudkey.pms.micros.og.common.UniqueID.Factory.parse(reader));
                                                        ...
                                                        object.setEventID((com.cloudkey.pms.micros.og.common.UniqueID[])
