...
/**
 * ReIssueMemberCardResponse.java
 *
 ...
 */
            ...
            /**
            *  ReIssueMemberCardResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReIssueMemberCardResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReIssueMemberCardResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ReIssueMemberCardResponse",
    ...
    public static class Factory{
        ...
        */
        public static ReIssueMemberCardResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReIssueMemberCardResponse object =
                new ReIssueMemberCardResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReIssueMemberCardResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReIssueMemberCardResponse)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
