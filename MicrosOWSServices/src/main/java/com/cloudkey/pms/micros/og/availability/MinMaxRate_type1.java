 ...
 */
            ...
            /**
            *  MinMaxRate_type1 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class MinMaxRate_type1 extends com.cloudkey.pms.micros.og.hotelcommon.MinMaxRate
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = MinMaxRate_type1
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MinMaxRate_type1",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MinMaxRate_type1",
                           xmlWriter);
                                                   ...
                                                   if (!java.lang.Double.isNaN(localMinimumRate)) {
                                               
                                                writeAttribute("",
                                                         "minimumRate",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMinimumRate), xmlWriter);

                                            
                                      }
                                    
                                                   if (!java.lang.Double.isNaN(localMaximumRate)) {
                                               
                                                writeAttribute("",
                                                         "maximumRate",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaximumRate), xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Availability/","MinMaxRate_type1"));
                
                            attribList.add(
                            new javax.xml.namespace.QName("","minimumRate"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMinimumRate));
                                
                            attribList.add(
                            new javax.xml.namespace.QName("","maximumRate"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaximumRate));
    ...
    public static class Factory{
        ...
        */
        public static MinMaxRate_type1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MinMaxRate_type1 object =
                new MinMaxRate_type1();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MinMaxRate_type1".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MinMaxRate_type1)com.cloudkey.pms.micros.ows.availability.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    // handle attribute "minimumRate"
                    java.lang.String tempAttribMinimumRate =
                        
                                reader.getAttributeValue(null,"minimumRate");
                            
                   if (tempAttribMinimumRate!=null){
                         java.lang.String content = tempAttribMinimumRate;
                        
                                                 object.setMinimumRate(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(tempAttribMinimumRate));
                                            
                    } else {
                       
                                           object.setMinimumRate(java.lang.Double.NaN);
                                       
                    }
                    handledAttributes.add("minimumRate");
                    
                    // handle attribute "maximumRate"
                    java.lang.String tempAttribMaximumRate =
                        
                                reader.getAttributeValue(null,"maximumRate");
                            
                   if (tempAttribMaximumRate!=null){
                         java.lang.String content = tempAttribMaximumRate;
                        
                                                 object.setMaximumRate(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(tempAttribMaximumRate));
                                            
                    } else {
                       
                                           object.setMaximumRate(java.lang.Double.NaN);
                                       
                    }
                    handledAttributes.add("maximumRate");
