...
/**
 * MeetingFetchBlockDelegatesRequest.java
 *
 ...
 */
            ...
            /**
            *  MeetingFetchBlockDelegatesRequest bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = MeetingFetchBlockDelegatesRequest
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for ContactProfileID
                        */

                        
                                    protected com.cloudkey.pms.micros.og.common.UniqueID localContactProfileID ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localContactProfileIDTracker = false ;

                           public boolean isContactProfileIDSpecified(){
                               return localContactProfileIDTracker;
                           }
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.common.UniqueID getContactProfileID(){
                               return localContactProfileID;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ContactProfileID
                               */
                               public void setContactProfileID(com.cloudkey.pms.micros.og.common.UniqueID param){
                            localContactProfileIDTracker = param != null;
                                   
                                            this.localContactProfileID=param;
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.cloudkey.pms.micros.og.common.UniqueID
                           */
                           public  com.cloudkey.pms.micros.og.common.UniqueID getEventID(){
                               return localEventID;
                           }
                            ...
                            /**
                               ...
                               * @param param EventID
                               */
                               public void setEventID(com.cloudkey.pms.micros.og.common.UniqueID param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MeetingFetchBlockDelegatesRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localHotelReferenceTracker){
                                           ...
                                           localHotelReference.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","HotelReference"),
                                               xmlWriter);
                                        } if (localContactProfileIDTracker){
                                            if (localContactProfileID==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ContactProfileID cannot be null!!");
                                            }
                                           localContactProfileID.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","ContactProfileID"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localHotelReferenceTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/",
                                    ...
                                    elementList.add(localContactProfileID);
                                } if (localBlockIdTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/",
                                                                      "BlockId"));
    ...
    public static class Factory{
        ...
        */
        public static MeetingFetchBlockDelegatesRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MeetingFetchBlockDelegatesRequest object =
                new MeetingFetchBlockDelegatesRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MeetingFetchBlockDelegatesRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MeetingFetchBlockDelegatesRequest)com.cloudkey.pms.micros.og.meetingroom.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","ContactProfileID").equals(reader.getName())){
                                
                                                object.setContactProfileID(com.cloudkey.pms.micros.og.common.UniqueID.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventID").equals(reader.getName())){
                                                ...
                                                object.setEventID(com.cloudkey.pms.micros.og.common.UniqueID.Factory.parse(reader));
