...
/**
 * OGHeaderAuthenticationLicence.java
 *
 ...
 */
            ...
            /**
            *  OGHeaderAuthenticationLicence bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = OGHeaderAuthenticationLicence
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OGHeaderAuthenticationLicence",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "OGHeaderAuthenticationLicence",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static OGHeaderAuthenticationLicence parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OGHeaderAuthenticationLicence object =
                new OGHeaderAuthenticationLicence();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OGHeaderAuthenticationLicence".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OGHeaderAuthenticationLicence)com.cloudkey.pms.micros.og.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
