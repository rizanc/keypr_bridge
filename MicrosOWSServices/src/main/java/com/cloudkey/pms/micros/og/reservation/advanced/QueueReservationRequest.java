 ...
 */
            ...
            /**
            *  QueueReservationRequest bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueueReservationRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueueReservationRequest",
                           xmlWriter);
                                           ...
                                           localActionType.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","ActionType"),
                                               xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static QueueReservationRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueueReservationRequest object =
                new QueueReservationRequest();
