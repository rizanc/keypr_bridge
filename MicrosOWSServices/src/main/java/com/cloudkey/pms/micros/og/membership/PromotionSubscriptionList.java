...
/**
 * PromotionSubscriptionList.java
 *
 ...
 */
            ...
            /**
            *  PromotionSubscriptionList bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for PromotionSubscription
                        * This was an Array!
                        */
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.membership.Promotion[] getPromotionSubscription(){
                               return localPromotionSubscription;
                           }
                              ...
                              /**
                               * validate the array for PromotionSubscription
                               */
                              ...
                              * @param param PromotionSubscription
                              */
                              public void setPromotionSubscription(com.cloudkey.pms.micros.og.membership.Promotion[] param){
                             ...
                             * @param param com.cloudkey.pms.micros.og.membership.Promotion
                             */
                             public void addPromotionSubscription(com.cloudkey.pms.micros.og.membership.Promotion param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPromotionSubscription);
                               list.add(param);
                               this.localPromotionSubscription =
                             (com.cloudkey.pms.micros.og.membership.Promotion[])list.toArray(
                            new com.cloudkey.pms.micros.og.membership.Promotion[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PromotionSubscriptionList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                       ...
                                       if (localPromotionSubscription!=null){
                                            for (int i = 0;i < localPromotionSubscription.length;i++){
                                                if (localPromotionSubscription[i] != null){
                                                 localPromotionSubscription[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Membership/","PromotionSubscription"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static PromotionSubscriptionList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PromotionSubscriptionList object =
                new PromotionSubscriptionList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PromotionSubscriptionList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PromotionSubscriptionList)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribMembershipId!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Membership/","PromotionSubscription").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list1.add(com.cloudkey.pms.micros.og.membership.Promotion.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Membership/","PromotionSubscription").equals(reader.getName())){
                                                                    list1.add(com.cloudkey.pms.micros.og.membership.Promotion.Factory.parse(reader));
                                                        ...
                                                        object.setPromotionSubscription((com.cloudkey.pms.micros.og.membership.Promotion[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.og.membership.Promotion.class,
                                                                list1));
