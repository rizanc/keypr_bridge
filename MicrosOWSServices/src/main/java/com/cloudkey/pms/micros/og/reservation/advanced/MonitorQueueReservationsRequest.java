...
/**
 * MonitorQueueReservationsRequest.java
 *
 ...
 */
            ...
            /**
            *  MonitorQueueReservationsRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "MonitorQueueReservationsRequest",
                "ns6");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MonitorQueueReservationsRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MonitorQueueReservationsRequest",
    ...
    public static class Factory{
        ...
        */
        public static MonitorQueueReservationsRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MonitorQueueReservationsRequest object =
                new MonitorQueueReservationsRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MonitorQueueReservationsRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MonitorQueueReservationsRequest)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
