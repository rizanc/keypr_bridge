 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase[] localEventDetails ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase[] getEventDetails(){
                              ...
                              /**
                               * validate the array for EventDetails
                               */
                              protected void validateEventDetails(com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase[] param){
                              ...
                              */
                              public void setEventDetails(com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase[] param){
                              
                                   validateEventDetails(param);

                               localEventDetailsTracker = param != null;
                             ...
                             /**
                             * Auto generated add method for the array for convenience
                             * @param param com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase
                             */
                             public void addEventDetails(com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase param){
                                   if (localEventDetails == null){
                                   localEventDetails = new com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localEventDetails);
                               list.add(param);
                               this.localEventDetails =
                             (com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase[])list.toArray(
                            new com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localProfileTracker){
                                       ...
                                       if (localEventDetails!=null){
                                            for (int i = 0;i < localEventDetails.length;i++){
                                                if (localEventDetails[i] != null){
                                                 localEventDetails[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventDetails"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("EventDetails cannot be null!!");
                             ...
                             if (localEventDetails!=null) {
                                 for (int i = 0;i < localEventDetails.length;i++){
                                    ...
                                    if (localEventDetails[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/",
                                                                          "EventDetails"));
                                         elementList.add(localEventDetails[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static MeetingEvent parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MeetingEvent object =
                new MeetingEvent();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MeetingEvent".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MeetingEvent)com.cloudkey.pms.micros.og.meetingroom.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventDetails").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list4.add(com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","EventDetails").equals(reader.getName())){
                                                                    list4.add(com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase.Factory.parse(reader));
                                                        ...
                                                        object.setEventDetails((com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.og.meetingroom.MeetingEventBase.class,
                                                                list4));
