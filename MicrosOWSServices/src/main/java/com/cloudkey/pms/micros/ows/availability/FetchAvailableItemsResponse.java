...
/**
 * FetchAvailableItemsResponse.java
 *
 ...
 */
            ...
            /**
            *  FetchAvailableItemsResponse bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = FetchAvailableItemsResponse
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for InventoryItems
                        */

                        
                                    protected com.cloudkey.pms.micros.og.hotelcommon.ArrayOfItemElement localInventoryItems ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localInventoryItemsTracker = false ;

                           public boolean isInventoryItemsSpecified(){
                               return localInventoryItemsTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.hotelcommon.ArrayOfItemElement
                           */
                           public  com.cloudkey.pms.micros.og.hotelcommon.ArrayOfItemElement getInventoryItems(){
                            ...
                            /**
                               ...
                               */
                               public void setInventoryItems(com.cloudkey.pms.micros.og.hotelcommon.ArrayOfItemElement param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FetchAvailableItemsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localResultTracker){
                                           ...
                                           localResult.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Availability.wsdl","Result"),
                                               xmlWriter);
                                        } if (localInventoryItemsTracker){
                                            if (localInventoryItems==null){
                                                 throw new org.apache.axis2.databinding.ADBException("InventoryItems cannot be null!!");
                                            }
                                           localInventoryItems.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Availability.wsdl","InventoryItems"),
                                               xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localResultTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Availability.wsdl",
                                    ...
                                    elementList.add(localInventoryItems);
                                }
    ...
    public static class Factory{
        ...
        */
        public static FetchAvailableItemsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FetchAvailableItemsResponse object =
                new FetchAvailableItemsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FetchAvailableItemsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FetchAvailableItemsResponse)com.cloudkey.pms.micros.ows.availability.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Availability.wsdl","InventoryItems").equals(reader.getName())){
                                                ...
                                                object.setInventoryItems(com.cloudkey.pms.micros.og.hotelcommon.ArrayOfItemElement.Factory.parse(reader));
