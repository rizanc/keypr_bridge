 ...
 */
            ...
            /**
            *  Cuisine_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Cuisine_type0
    ...
    public static class Factory{
        ...
        */
        public static Cuisine_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Cuisine_type0 object =
                new Cuisine_type0();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Cuisine_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Cuisine_type0)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
