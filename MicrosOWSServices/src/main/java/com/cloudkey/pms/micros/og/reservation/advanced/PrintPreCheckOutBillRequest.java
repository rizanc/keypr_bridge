...
/**
 * PrintPreCheckOutBillRequest.java
 *
 ...
 */
            ...
            /**
            *  PrintPreCheckOutBillRequest bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = PrintPreCheckOutBillRequest
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for ReturnFileContents
                        * This was an Attribute!
                        */

                        
                                    protected boolean localReturnFileContents ;
                           ...
                           * @return boolean
                           */
                           public  boolean getReturnFileContents(){
                               return localReturnFileContents;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ReturnFileContents
                               */
                               public void setReturnFileContents(boolean param){
                            
                                            this.localReturnFileContents=param;
                        ...
                        /**
                        * field for GenerateFile
                        * This was an Attribute!
                        */

                        
                                    protected boolean localGenerateFile ;
                           ...
                           */
                           public  boolean getGenerateFile(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param GenerateFile
                               */
                               public void setGenerateFile(boolean param){
                            
                                            this.localGenerateFile=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PrintPreCheckOutBillRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                                ...
                                                writeAttribute("",
                                                         "returnFileContents",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localReturnFileContents), xmlWriter);
                                                ...
                                                writeAttribute("",
                                                         "generateFile",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localGenerateFile), xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localReservationRequestTracker){
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","returnFileContents"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localReturnFileContents));
                                
                            attribList.add(
                            new javax.xml.namespace.QName("","generateFile"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localGenerateFile));
    ...
    public static class Factory{
        ...
        */
        public static PrintPreCheckOutBillRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PrintPreCheckOutBillRequest object =
                new PrintPreCheckOutBillRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PrintPreCheckOutBillRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PrintPreCheckOutBillRequest)com.cloudkey.pms.micros.og.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribEmailFolio!=null){
                    ...
                    // handle attribute "returnFileContents"
                    java.lang.String tempAttribReturnFileContents =
                        
                                reader.getAttributeValue(null,"returnFileContents");
                            
                   if (tempAttribReturnFileContents!=null){
                         java.lang.String content = tempAttribReturnFileContents;
                        
                                                 object.setReturnFileContents(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(tempAttribReturnFileContents));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("returnFileContents");
                    
                    // handle attribute "generateFile"
                    java.lang.String tempAttribGenerateFile =
                        
                                reader.getAttributeValue(null,"generateFile");
                            
                   if (tempAttribGenerateFile!=null){
                         java.lang.String content = tempAttribGenerateFile;
                        
                                                 object.setGenerateFile(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(tempAttribGenerateFile));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("generateFile");
