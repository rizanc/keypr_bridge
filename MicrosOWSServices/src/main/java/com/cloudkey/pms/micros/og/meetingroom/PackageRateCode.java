 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for PackageEventRates
                        * This was an Array!
                        */

                        
                                    protected com.cloudkey.pms.micros.og.meetingroom.EventRate[] localPackageEventRates ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPackageEventRatesTracker = false ;

                           public boolean isPackageEventRatesSpecified(){
                               return localPackageEventRatesTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.meetingroom.EventRate[]
                           */
                           public  com.cloudkey.pms.micros.og.meetingroom.EventRate[] getPackageEventRates(){
                               return localPackageEventRates;
                           }
                              ...
                              /**
                               * validate the array for PackageEventRates
                               */
                              protected void validatePackageEventRates(com.cloudkey.pms.micros.og.meetingroom.EventRate[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param PackageEventRates
                              */
                              public void setPackageEventRates(com.cloudkey.pms.micros.og.meetingroom.EventRate[] param){
                              
                                   validatePackageEventRates(param);

                               localPackageEventRatesTracker = param != null;
                                      
                                      this.localPackageEventRates=param;
                              }
                             ...
                             * @param param com.cloudkey.pms.micros.og.meetingroom.EventRate
                             */
                             public void addPackageEventRates(com.cloudkey.pms.micros.og.meetingroom.EventRate param){
                                   if (localPackageEventRates == null){
                                   localPackageEventRates = new com.cloudkey.pms.micros.og.meetingroom.EventRate[]{};
                                   }

                            
                                 //update the setting tracker
                                localPackageEventRatesTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPackageEventRates);
                               list.add(param);
                               this.localPackageEventRates =
                             (com.cloudkey.pms.micros.og.meetingroom.EventRate[])list.toArray(
                            new com.cloudkey.pms.micros.og.meetingroom.EventRate[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PackageRateCode",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PackageRateCode",
                           xmlWriter);
                              ...
                              if (localRateDescriptionTracker){
                                           ...
                                           localRateDescription.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","RateDescription"),
                                               xmlWriter);
                                        } if (localPackageEventRatesTracker){
                                       if (localPackageEventRates!=null){
                                            for (int i = 0;i < localPackageEventRates.length;i++){
                                                if (localPackageEventRates[i] != null){
                                                 localPackageEventRates[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","PackageEventRates"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("PackageEventRates cannot be null!!");
                             ...
                             if (localPackageEventRates!=null) {
                                 for (int i = 0;i < localPackageEventRates.length;i++){
                                    ...
                                    if (localPackageEventRates[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/",
                                                                          "PackageEventRates"));
                                         elementList.add(localPackageEventRates[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static PackageRateCode parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PackageRateCode object =
                new PackageRateCode();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PackageRateCode".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PackageRateCode)com.cloudkey.pms.micros.og.hotelcommon.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribHourlyRate!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","PackageEventRates").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list3.add(com.cloudkey.pms.micros.og.meetingroom.EventRate.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","PackageEventRates").equals(reader.getName())){
                                                                    list3.add(com.cloudkey.pms.micros.og.meetingroom.EventRate.Factory.parse(reader));
                                                        ...
                                                        object.setPackageEventRates((com.cloudkey.pms.micros.og.meetingroom.EventRate[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cloudkey.pms.micros.og.meetingroom.EventRate.class,
                                                                list3));
