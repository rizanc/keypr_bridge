...
/**
 * MeetingFetchMiscellaneousItemResponse.java
 *
 ...
 */
            ...
            /**
            *  MeetingFetchMiscellaneousItemResponse bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = MeetingFetchMiscellaneousItemResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MeetingFetchMiscellaneousItemResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static MeetingFetchMiscellaneousItemResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MeetingFetchMiscellaneousItemResponse object =
                new MeetingFetchMiscellaneousItemResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MeetingFetchMiscellaneousItemResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MeetingFetchMiscellaneousItemResponse)com.cloudkey.pms.micros.og.meetingroom.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list2.add(com.cloudkey.pms.micros.og.meetingroom.MiscellaneousItem.Factory.parse(reader));
