 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for RoomNoRequested
                        */

                        
                                    protected java.lang.String localRoomNoRequested ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRoomNoRequestedTracker = false ;

                           public boolean isRoomNoRequestedSpecified(){
                               return localRoomNoRequestedTracker;
                           }
                           ...
                           */
                           public  java.lang.String getRoomNoRequested(){
                               return localRoomNoRequested;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RoomNoRequested
                               */
                               public void setRoomNoRequested(java.lang.String param){
                            localRoomNoRequestedTracker = param != null;
                                   
                                            this.localRoomNoRequested=param;
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localStationIDTracker = false ;

                           public boolean isStationIDSpecified(){
                               return localStationIDTracker;
                           }
                           ...
                           */
                           public  java.lang.String getStationID(){
                            ...
                            localStationIDTracker = param != null;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AssignRoomRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AssignRoomRequest",
                ...
                if (localHotelReferenceTracker){
                                    ...
                                    writeStartElement(null, namespace, "RoomNoRequested", xmlWriter);
                                          ...
                                          if (localRoomNoRequested==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("RoomNoRequested cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localRoomNoRequested);
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             } if (localStationIDTracker){
                                    namespace = "http://webservices.micros.com/ows/5.1/Reservation.wsdl";
                                    writeStartElement(null, namespace, "StationID", xmlWriter);
                                          ...
                                          if (localStationID==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("StationID cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localStationID);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl",
                                    ...
                                    elementList.add(localResvNameId);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl",
                                        ...
                                        if (localRoomNoRequested != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRoomNoRequested));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("RoomNoRequested cannot be null!!");
                                        }
                                    } if (localStationIDTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl",
                                        ...
                                        if (localStationID != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localStationID));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("StationID cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static AssignRoomRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AssignRoomRequest object =
                new AssignRoomRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AssignRoomRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AssignRoomRequest)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl","RoomNoRequested").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"RoomNoRequested" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setRoomNoRequested(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl","StationID").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"StationID" +"  cannot be null");
                                    }
