...
/**
 * FetchAuthorizationsHistoryResponse.java
 *
 ...
 */
            ...
            /**
            *  FetchAuthorizationsHistoryResponse bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "FetchAuthorizationsHistoryResponse",
                "ns6");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FetchAuthorizationsHistoryResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FetchAuthorizationsHistoryResponse",
    ...
    public static class Factory{
        ...
        */
        public static FetchAuthorizationsHistoryResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FetchAuthorizationsHistoryResponse object =
                new FetchAuthorizationsHistoryResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FetchAuthorizationsHistoryResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FetchAuthorizationsHistoryResponse)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list2.add(com.cloudkey.pms.micros.og.hotelcommon.CreditCardAuthorizationDetail.Factory.parse(reader));
