 ...
 */
                                       ...
                                       if (localProfile!=null){
                                            for (int i = 0;i < localProfile.length;i++){
                                                if (localProfile[i] != null){
                                                 localProfile[i].serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Name/","Profile"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static ProfileList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProfileList object =
                new ProfileList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ProfileList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ProfileList)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Name/","Profile").equals(reader.getName())){
                                    ...
                                    list1.add(com.cloudkey.pms.micros.og.name.Profile.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Name/","Profile").equals(reader.getName())){
                                                                    list1.add(com.cloudkey.pms.micros.og.name.Profile.Factory.parse(reader));
