...
/**
 * SetResPromotionCodeRequest.java
 *
 ...
 */
            ...
            /**
            *  SetResPromotionCodeRequest bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = SetResPromotionCodeRequest
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getPromotionCode(){
                               ...
                               */
                              protected void validatePromotionCode(java.lang.String[] param){
                             ...
                             */
                             public void addPromotionCode(java.lang.String param){
                                   if (localPromotionCode == null){
                                   localPromotionCode = new java.lang.String[]{};
                                   }
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SetResPromotionCodeRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                   ...
                                   for (int i = 0;i < localPromotionCode.length;i++){
                                            ...
                                            if (localPromotionCode[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "PromotionCode", xmlWriter);
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPromotionCode[i]));
                                  ...
                                  for (int i = 0;i < localPromotionCode.length;i++){
                                         ...
                                         if (localPromotionCode[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/",
                                                                              "PromotionCode"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPromotionCode[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static SetResPromotionCodeRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetResPromotionCodeRequest object =
                new SetResPromotionCodeRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SetResPromotionCodeRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetResPromotionCodeRequest)com.cloudkey.pms.micros.og.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list2.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setPromotionCode((java.lang.String[])
