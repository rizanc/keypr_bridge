 ...
 */
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.hotelcommon.Room
                           */
                           public  com.cloudkey.pms.micros.og.hotelcommon.Room getRoom(){
                               return localRoom;
                           }
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CheckInComplete",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CheckInComplete",
                           xmlWriter);
                                            ...
                                            if (localInvoiceNumber != null){
                                                ...
                                                writeAttribute("",
                                                         "InvoiceNumber",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localInvoiceNumber), xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localReservationIDTracker){
                            ...
                            new javax.xml.namespace.QName("","InvoiceNumber"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localInvoiceNumber));
    ...
    public static class Factory{
        ...
        */
        public static CheckInComplete parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CheckInComplete object =
                new CheckInComplete();
            ...
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribGuestRegistration!=null){
                    ...
                    // handle attribute "InvoiceNumber"
                    java.lang.String tempAttribInvoiceNumber =
                        
                                reader.getAttributeValue(null,"InvoiceNumber");
                            
                   if (tempAttribInvoiceNumber!=null){
                         java.lang.String content = tempAttribInvoiceNumber;
                        
                                                 object.setInvoiceNumber(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribInvoiceNumber));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("InvoiceNumber");
                   ...
                   if (tempAttribDoNotMoveRoom!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","Room").equals(reader.getName())){
                                
                                                object.setRoom(com.cloudkey.pms.micros.og.hotelcommon.Room.Factory.parse(reader));
