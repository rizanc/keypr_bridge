 ...
 */
            ...
            /**
            *  AssignRoomAdvRequest bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AssignRoomAdvRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AssignRoomAdvRequest",
    ...
    public static class Factory{
        ...
        */
        public static AssignRoomAdvRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AssignRoomAdvRequest object =
                new AssignRoomAdvRequest();
            ...
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","RoomNoRequested").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","StationID").equals(reader.getName())){
