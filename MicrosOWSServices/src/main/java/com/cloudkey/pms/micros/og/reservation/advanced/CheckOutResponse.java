 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns6");
                        ...
                        /**
                        * field for CheckOutComplete
                        */

                        
                                    protected com.cloudkey.pms.micros.og.reservation.advanced.CheckOutComplete localCheckOutComplete ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCheckOutCompleteTracker = false ;

                           public boolean isCheckOutCompleteSpecified(){
                               return localCheckOutCompleteTracker;
                           }
                           ...
                           * @return com.cloudkey.pms.micros.og.reservation.advanced.CheckOutComplete
                           */
                           public  com.cloudkey.pms.micros.og.reservation.advanced.CheckOutComplete getCheckOutComplete(){
                               return localCheckOutComplete;
                           }
                            ...
                            /**
                               ...
                               * @param param CheckOutComplete
                               */
                               public void setCheckOutComplete(com.cloudkey.pms.micros.og.reservation.advanced.CheckOutComplete param){
                            localCheckOutCompleteTracker = param != null;
                                   
                                            this.localCheckOutComplete=param;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CheckOutResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CheckOutResponse",
                ...
                if (localCheckOutCompleteTracker){
                                            if (localCheckOutComplete==null){
                                                 throw new org.apache.axis2.databinding.ADBException("CheckOutComplete cannot be null!!");
                                            }
                                           localCheckOutComplete.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","CheckOutComplete"),
                                               xmlWriter);
                                        } if (localProfileTracker){
                                            if (localProfile==null){
                                                 throw new org.apache.axis2.databinding.ADBException("Profile cannot be null!!");
                                            }
                                           localProfile.serialize(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","Profile"),
                                               xmlWriter);
                                        }
                                            if (localResult==null){
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localCheckOutCompleteTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/",
                                    ...
                                    elementList.add(localCheckOutComplete);
                                } if (localProfileTracker){
                            elementList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/",
                                                                      "Profile"));
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CheckOutResponse".equals(type)){
                                ...
                                return (CheckOutResponse)com.cloudkey.pms.micros.ows.reservation.advanced.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","CheckOutComplete").equals(reader.getName())){
                                
                                                object.setCheckOutComplete(com.cloudkey.pms.micros.og.reservation.advanced.CheckOutComplete.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/ResvAdvanced/","Profile").equals(reader.getName())){
