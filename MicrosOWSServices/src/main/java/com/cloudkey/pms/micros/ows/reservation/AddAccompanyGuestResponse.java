...
/**
 * AddAccompanyGuestResponse.java
 *
 ...
 */
            ...
            /**
            *  AddAccompanyGuestResponse bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = AddAccompanyGuestResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AddAccompanyGuestResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AddAccompanyGuestResponse",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static AddAccompanyGuestResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddAccompanyGuestResponse object =
                new AddAccompanyGuestResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AddAccompanyGuestResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddAccompanyGuestResponse)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
