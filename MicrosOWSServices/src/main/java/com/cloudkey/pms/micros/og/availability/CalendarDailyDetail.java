 ...
 */
            ...
            /**
            *  CalendarDailyDetail bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.availability.CalendarRate localRates ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.cloudkey.pms.micros.og.availability.CalendarRate
                           */
                           public  com.cloudkey.pms.micros.og.availability.CalendarRate getRates(){
                               return localRates;
                           }
                            ...
                            /**
                               ...
                               * @param param Rates
                               */
                               public void setRates(com.cloudkey.pms.micros.og.availability.CalendarRate param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CalendarDailyDetail",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CalendarDailyDetail",
    ...
    public static class Factory{
        ...
        */
        public static CalendarDailyDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CalendarDailyDetail object =
                new CalendarDailyDetail();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CalendarDailyDetail".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CalendarDailyDetail)com.cloudkey.pms.micros.ows.availability.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribDate!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/Availability/","Rates").equals(reader.getName())){
                                
                                                object.setRates(com.cloudkey.pms.micros.og.availability.CalendarRate.Factory.parse(reader));
