...
/**
 * MeetingEventBaseMenuItems.java
 *
 ...
 */
            ...
            /**
            *  MeetingEventBaseMenuItems bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class MeetingEventBaseMenuItems extends com.cloudkey.pms.micros.og.meetingroom.MenuItem
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = MeetingEventBaseMenuItems
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MeetingEventBaseMenuItems",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://webservices.micros.com/og/4.3/MeetingRoom/","MeetingEventBaseMenuItems"));
                 if (localMenuItemIDTracker){
    ...
    public static class Factory{
        ...
        */
        public static MeetingEventBaseMenuItems parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MeetingEventBaseMenuItems object =
                new MeetingEventBaseMenuItems();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MeetingEventBaseMenuItems".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MeetingEventBaseMenuItems)com.cloudkey.pms.micros.og.meetingroom.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
