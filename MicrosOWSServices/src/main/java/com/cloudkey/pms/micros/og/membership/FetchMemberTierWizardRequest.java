...
/**
 * FetchMemberTierWizardRequest.java
 *
 ...
 */
            ...
            /**
            *  FetchMemberTierWizardRequest bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected java.util.Date localEvaluationDate ;
                           ...
                           */
                           public  java.util.Date getEvaluationDate(){
                            ...
                            /**
                               ...
                               */
                               public void setEvaluationDate(java.util.Date param){
                        ...
                        /**
                        * field for EvaluationType
                        * This was an Attribute!
                        */

                        
                                    protected com.cloudkey.pms.micros.og.membership.EvaluationTypes localEvaluationType ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.cloudkey.pms.micros.og.membership.EvaluationTypes
                           */
                           public  com.cloudkey.pms.micros.og.membership.EvaluationTypes getEvaluationType(){
                               return localEvaluationType;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param EvaluationType
                               */
                               public void setEvaluationType(com.cloudkey.pms.micros.og.membership.EvaluationTypes param){
                            
                                            this.localEvaluationType=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FetchMemberTierWizardRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                            ...
                                            if (localEvaluationDate != null){
                                                ...
                                                writeAttribute("",
                                                         "evaluationDate",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localEvaluationDate), xmlWriter);

                                            
                                      }
                                    
                                      else {
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localEvaluationDate is null");
                                      }
                                    ...
                                    if (localEvaluationType != null){
                                        writeAttribute("",
                                           "evaluationType",
                                           localEvaluationType.toString(), xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localMembershipIDTracker){
                            ...
                            new javax.xml.namespace.QName("","evaluationDate"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localEvaluationDate));
                                
                            attribList.add(
                            new javax.xml.namespace.QName("","evaluationType"));
                            
                                      attribList.add(localEvaluationType.toString());
    ...
    public static class Factory{
        ...
        */
        public static FetchMemberTierWizardRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FetchMemberTierWizardRequest object =
                new FetchMemberTierWizardRequest();
                   ...
                   if (tempAttribEvaluationDate!=null){
                         java.lang.String content = tempAttribEvaluationDate;
                                                 ...
                                                 object.setEvaluationDate(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDate(tempAttribEvaluationDate));
                                            
                    } else {
                       
                               throw new org.apache.axis2.databinding.ADBException("Required attribute evaluationDate is missing");
                           
                    }
                    handledAttributes.add("evaluationDate");
                    
                    // handle attribute "evaluationType"
                    java.lang.String tempAttribEvaluationType =
                        
                                reader.getAttributeValue(null,"evaluationType");
                            
                   if (tempAttribEvaluationType!=null){
                         java.lang.String content = tempAttribEvaluationType;
                        
                                                  object.setEvaluationType(
                                                        com.cloudkey.pms.micros.og.membership.EvaluationTypes.Factory.fromString(reader,tempAttribEvaluationType));
                                            
                    } else {
                       
                               throw new org.apache.axis2.databinding.ADBException("Required attribute evaluationType is missing");
                           
                    }
                    handledAttributes.add("evaluationType");
