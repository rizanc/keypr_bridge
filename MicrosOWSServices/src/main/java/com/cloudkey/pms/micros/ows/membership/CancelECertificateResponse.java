...
/**
 * CancelECertificateResponse.java
 *
 ...
 */
            ...
            /**
            *  CancelECertificateResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CancelECertificateResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CancelECertificateResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CancelECertificateResponse",
    ...
    public static class Factory{
        ...
        */
        public static CancelECertificateResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CancelECertificateResponse object =
                new CancelECertificateResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CancelECertificateResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CancelECertificateResponse)com.cloudkey.pms.micros.ows.membership.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
