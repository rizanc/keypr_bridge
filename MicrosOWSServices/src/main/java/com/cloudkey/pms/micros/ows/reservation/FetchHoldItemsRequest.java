 ...
 */
            ...
            /**
            *  FetchHoldItemsRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns7");
                        ...
                        */
                                    ...
                                    protected com.cloudkey.pms.micros.og.common.UniqueIDList localItemHoldIDList ;
                           ...
                           */
                           public  com.cloudkey.pms.micros.og.common.UniqueIDList getItemHoldIDList(){
                            ...
                            /**
                               ...
                               */
                               public void setItemHoldIDList(com.cloudkey.pms.micros.og.common.UniqueIDList param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FetchHoldItemsRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FetchHoldItemsRequest",
    ...
    public static class Factory{
        ...
        */
        public static FetchHoldItemsRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FetchHoldItemsRequest object =
                new FetchHoldItemsRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FetchHoldItemsRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FetchHoldItemsRequest)com.cloudkey.pms.micros.ows.reservation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webservices.micros.com/ows/5.1/Reservation.wsdl","ItemHoldIDList").equals(reader.getName())){
                                                ...
                                                object.setItemHoldIDList(com.cloudkey.pms.micros.og.common.UniqueIDList.Factory.parse(reader));
