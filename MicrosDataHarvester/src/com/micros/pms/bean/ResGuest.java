...
public class ResGuest {
    ...
    @XmlElement(name = "Profiles", namespace = "http://webservices.micros.com/og/4.3/Reservation/")
    protected ProfileList profiles;
    @XmlElement(name = "SpecialRequests", namespace = "http://webservices.micros.com/og/4.3/Reservation/")
    protected SpecialRequestList specialRequests;
    @XmlElement(name = "Comments", namespace = "http://webservices.micros.com/og/4.3/Reservation/")
    protected ReservationCommentList comments;
    @XmlElement(name = "ArrivalTransport", namespace = "http://webservices.micros.com/og/4.3/Reservation/")
    protected TransportInfo arrivalTransport;
    @XmlElement(name = "DepartureTransport", namespace = "http://webservices.micros.com/og/4.3/Reservation/")
    ...
    @XmlElement(name = "InHouseTimeSpan", namespace = "http://webservices.micros.com/og/4.3/Reservation/")
