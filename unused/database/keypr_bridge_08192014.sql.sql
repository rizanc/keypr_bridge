...
CREATE TABLE `reservation_upload` (
  ...
  `check_in_date` date DEFAULT NULL COMMENT 'StayDateRange.startTime',
  `check_out_date` date DEFAULT NULL COMMENT 'StayDateRange.startTime + StayDateRange.numberOfTimeUnits',
